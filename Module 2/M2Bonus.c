        ...
        BeginDrawing();
            ...
            switch(currentScreen)
            {
                ...
                case TITLE:
                {
                    ...
                    DrawText("TITLE SCREEN", 20, 20, 40, BEIGE);
                    DrawText("PRESS ENTER or TAP to JUMP to GAMEPLAY SCREEN", 120, 220, 20, BEIGE);
                ...
                case GAMEPLAY:
                {
                    ...
                    //
                    DrawCircle(player_x, player_y, 30, DARKBLUE);
                    DrawCircle(player_x, player_y, 20, BLUE);
                    DrawCircle(player_x, player_y, 10, SKYBLUE);
